...
- [ ] Ajouter une exception au git.ignore pour le dossier MazeVR-Shared : ne pas ignorer le projet Visual Studio ([aide](https://stackoverflow.com/questions/3203228/git-ignore-exception)).
